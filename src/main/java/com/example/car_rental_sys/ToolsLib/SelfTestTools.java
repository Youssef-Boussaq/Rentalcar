...
//        boolean res = NetTools.netIsAvailable(ConfigFile.connectTestUrl);
    ...
    private static void isJxBrowserLicensed() {
        ...
        StatusContainer.isJxBrowserRegistered = true;
        new Test("WebView", true, message,"WebView is used.");
        System.out.println( "WebView: " + true + "||" + DateTools.getNow() + "||" + getTimeCost()) ;
    }
    ...
    private static void showTestMsg(){
        ...
        // Bypassed: force the application to be runnable despite missing JxBrowser license or backend.
