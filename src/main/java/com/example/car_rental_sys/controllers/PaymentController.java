...
//        engine.load("https://html5test.com");
        engine.load(new File("src/main/resources/com/example/car_rental_sys/html/payMethods/new/loginToPaypal.html").toURI().toString());
        //engine.load(new File("src/main/resources/com/example/car_rental_sys/html/payMethods/PayPalCheckout.html").toURI().toString());
        ...
        Scene scene = new Scene(new BorderPane(webView), 800, 700);
    ...
    private void showBankCardCheckoutPage() {
        ...
        engine.load(new File("src/main/resources/com/example/car_rental_sys/html/payMethods/checkout.html").toURI().toString());
        ...
        Scene scene = new Scene(new BorderPane(webView), 1100, 700);
