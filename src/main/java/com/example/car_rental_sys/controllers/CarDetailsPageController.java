...
public class CarDetailsPageController extends  Controller{
    ...
    private void makeAPayment(){
        ...
        String sql2 = "insert into orders values (" + orderID + "," + carID + ",'" + orderTime + "','" + pickUpTime + "','" + returnTime + "','" + parkingLocation + "','" + pickUpLocation + "'," + userID + "," + price + ",'" + paymentMethod + "','" + account + "'," + status + "," + star + ")";
