...
//        System.out.println(type + "lallala");
        if (type.equalsIgnoreCase("green")){
            logoLabel.setStyle("-fx-font-family: 'Segoe UI'; -fx-font-size: 24px; -fx-font-weight: bold; -fx-text-fill: white;");
        }else if (type.equalsIgnoreCase("blue")){
            logoLabel.setStyle("-fx-font-family: 'Segoe UI'; -fx-font-size: 24px; -fx-font-weight: bold; -fx-text-fill: #1D90F4;");
        }
    }
}
